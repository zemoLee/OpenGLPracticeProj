package com.sf.opengldemo1.practice7.program;
...
public class BaseShaderProgram {
    ...
    private void  loadProgram(){
        mProgram = ShaderHelper.buildProgram(TextResourceReader.readTextResourceFromRaw(context,
                R.raw.practice_7_vertext_shader), TextResourceReader.readTextResourceFromRaw(context,
                R.raw.practice_7_fragment_shader));
    }
