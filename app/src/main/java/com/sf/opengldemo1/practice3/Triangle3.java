...
public class Triangle3 {
    ...
    public Triangle3() {
        ...
        //加载编译顶点着色器
        int vertexShader = PracticeRender3.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        //加载编译偏于着色器
        int fragmentShader = PracticeRender3.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
