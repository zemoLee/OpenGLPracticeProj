package com.sf.opengldemo1.practice14.view;

import android.content.Context;
import android.graphics.BitmapFactory;
import android.opengl.GLES20;

import com.sf.opengldemo1.practice14.objhelper.MtlInfo;
import com.sf.opengldemo1.practice14.shaderhelper.TextureHelper;
import com.sf.opengldemo1.practice14.shaderprogram.Obj3DShaderProgram;
...
//        GLES20.glVertexAttribPointer(mProgram.getmNormalHandle(),3, GLES20.GL_FLOAT, false, 0, normalBuffer);//vertexStride=0
//        //vertex
//        GLES20.glVertexAttribPointer(mProgram.getaPositionHandle(),COORD_PER_VERTEX,GLES20.GL_FLOAT,false,0, vertexBuffer);//vertexStride=0
...
//        GLES20.glVertexAttribPointer(mProgram.getaCoordinateHandle(),2,GLES20.GL_FLOAT,false,0, textureBuffer); //size改为2 ，vertexStride=0
//
//        //纹理取样绑定
...
//
//        //光照
//        GLES20.glUniform3fv(mProgram.getuKaHandle(),1,mtl.Ka,0);
//        GLES20.glUniform3fv(mProgram.getuKdHandle(),1,mtl.Kd,0);
//        GLES20.glUniform3fv(mProgram.getuKsHandle(),1,mtl.Ks,0);
//
...
//        GLES20.glDisableVertexAttribArray(mProgram.getaCoordinateHandle());
...
//        textureId = TextureHelperKt.createTexture(BitmapFactory.decodeStream(context.getAssets().open("3dres/"+obj.mtl.map_Kd)));
        if(mtl!=null){
            try {
                textureId=TextureHelper.createTexture(BitmapFactory.decodeStream(context.getAssets().open("3dobj/"+this.mtl.map_Kd)));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
