...
public class GLTextureView2 extends TextureView implements TextureView.SurfaceTextureListener {
     ...
     * this interface, and then call {@link GLTextureView2#setRenderer} to
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link GLTextureView2#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GLTextureView2> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            GLTextureView2 view = mGLTextureViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        public static String formatEglError(String function, int error) {
            return function + " failed: " + "errorCode:" + error + " " + GLES20.glGetError();
        }

        private WeakReference<GLTextureView2> mGLTextureViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLTextureView2> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
    ...
    private final WeakReference<GLTextureView2> mThisWeakRef =
            new WeakReference<GLTextureView2>(this);
